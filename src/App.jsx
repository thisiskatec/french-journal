...
const CHAPTERS = [
  ...
  {
    id:"0714", level:"4", noteLinks:[], date:"07/14", weekday:"一", topic:"法國國慶・命令式綜合・gérondif・反身動詞過去式",
    tags:["impératif","gérondif","反身動詞","國慶"],
    summary:[
      {text:"14 juillet = la fête nationale française = la fête de la Bastille（法國國慶／攻佔巴士底獄）"},
      {text:"命令式綜合：情境給建議（Il pleut, prends un parapluie !）"},
      {text:"gérondif = en + 現在分詞 = 一邊...一邊（Je dine en regardant la télé.）"},
      {text:"反身動詞過去式：se + être + PP（配合性別）"},
      {text:"⚠️ 反身+身體部位：Je me suis brossé les dents.（有受詞，PP不配合）"},
    ],
    vocabItems:[
      {word:"la fête nationale",meaning:"國慶日",example:"Le 14 juillet, c'est la fête nationale française."},
      {word:"la fête de la Bastille",meaning:"攻佔巴士底獄紀念日",example:"La fête de la Bastille célèbre la Révolution française."},
      {word:"ne fais pas de bruit",meaning:"別發出聲音",example:"Ton père dort, ne fais pas de bruit !"},
      {word:"faire une sieste",meaning:"午睡",example:"C'est dimanche, fais une sieste jusqu'à 15h."},
      {word:"être en colère / fâché(e)",meaning:"生氣",example:"Elle est en colère. Elle est fâchée."},
      {word:"s'inquiéter",meaning:"擔心",example:"Ne vous inquiétez pas, j'ai compris."},
      {word:"T'inquiète ! (oral)",meaning:"別擔心（口語）",example:"T'inquiète ! Pas de souci."},
      {word:"s'amuser",meaning:"玩得開心",example:"Amusez-vous bien, les enfants !"},
      {word:"s'énerver",meaning:"動怒/煩躁",example:"Ne vous énervez pas ! Ça ne change rien."},
      {word:"mentir",meaning:"說謊",example:"je mens, tu mens, il ment, nous mentons, vous mentez, ils mentent"},
      {word:"un menteur / une menteuse",meaning:"騙子",example:"Menteur ! Mon œil ! Je ne crois pas !"},
      {word:"en + participe présent",meaning:"一邊...一邊（gérondif）",example:"Je fais mes devoirs en chantant."},
      {word:"le coucher du soleil",meaning:"日落",example:"Je vois toujours le coucher du soleil en rentrant."},
      {word:"se maquiller",meaning:"化妝",example:"Tu t'es maquillée aujourd'hui ? Oui, je me suis maquillée."},
      {word:"se parfumer",meaning:"噴香水",example:"Tu t'es parfumée hier ? Non."},
      {word:"se coiffer",meaning:"梳頭",example:"Je ne me coiffe pas, j'ai les cheveux courts."},
      {word:"Bon rétablissement !",meaning:"早日康復！",example:"Tu es malade ? Bon rétablissement !"},
    ],
    grammar:[
      {title:"gérondif：en + 現在分詞",content:"gérondif = en + 現在分詞（動詞 nous 形去 -ons + -ant）\n表示「一邊...一邊」，同一主詞的兩個同時動作\n\nJe dine en regardant la télé.（我一邊看電視一邊吃飯）\nJe fais mes devoirs en chantant.（一邊唱歌一邊做作業）\nElle prend son café en écoutant de la musique.\n\n形成：regarder→regardant / chanter→chantant / finir→finissant\n⚠️ 例外：être→étant / avoir→ayant / savoir→sachant"},
      {title:"反身動詞過去式 + 身體部位",content:"一般反身：PP 配合主詞性別\nJe me suis levée.（女）/ Elle s'est maquillée.\n\n⚠️ 反身 + 身體部位/受詞：PP 不配合！\nJe me suis brossé les dents.（不加e，因為後面有 les dents）\nJe me suis lavé les mains.\nElle s'est coupé les cheveux.\n\n對比：\nJe me suis lavée.（我洗澡了，配合→e）\nJe me suis lavé les mains.（我洗手，不配合）"},
    ],
    exercises:[
      {type:"選",q:"「一邊唱歌一邊做作業」",opts:["Je fais mes devoirs pour chanter.","Je fais mes devoirs en chantant.","Je fais mes devoirs en chanter."],ans:1,exp:"gérondif = en + 現在分詞（chantant）"},
      {type:"填",q:"Ne vous ___ pas ! Ça ne change rien.（s'énerver, vous）/ Je me suis brossé ___ dents.",blanks:["énervez","les"],hint:"s'énerver→énervez / 身體部位前用 les"},
    ],
    dialogue:[
      {s:"A",t:"Amusez-vous bien, les enfants !"},
      {s:"B",t:"Merci maman !"},
      {s:"A",t:"Ne rentrez pas trop tard !"},
      {s:"B",t:"T'inquiète ! On rentre avant minuit."},
      {s:"A",t:"Tu t'es levée à quelle heure ?"},
      {s:"B",t:"Je me suis réveillée à 9h, mais je me suis levée à 10h !"},
    ],
    tip:"gérondif 超實用！en + -ant = 一邊...一邊\nen mangeant / en marchant / en travaillant\n⚠️ 一定要同一個主詞的兩個同時動作"
  },
  {
    id:"0716", level:"4", noteLinks:[], date:"07/16", weekday:"四", topic:"數量詞・~al→~aux・ne...personne・辦派對",
    tags:["數量","quantité","ne...personne","複數"],
    summary:[
      {text:"peu de = 很少（可數/不可數都可）/ un peu de = 一點（只用不可數）"},
      {text:"quelques / plusieurs = 幾個/好幾個（只用可數）"},
      {text:"~al → ~aux 複數：un animal → des animaux / un journal → des journaux"},
      {text:"ne...personne + 原形動詞：Je n'aime voyager avec personne.（我不喜歡跟任何人旅行）"},
      {text:"辦派對詞彙：à manger / à boire / des jeux de société"},
    ],
    vocabItems:[
      {word:"peu de + nom",meaning:"很少（可數/不可數）",example:"Il a peu de livres. Il prend peu de sucre."},
      {word:"un peu de + nom",meaning:"一點（只用不可數）",example:"Je mets un peu de lait dans mon café."},
      {word:"quelques + nom",meaning:"幾個（可數）",example:"Il a quelques amis étrangers."},
      {word:"plusieurs + nom",meaning:"好幾個（可數）",example:"J'ai vu plusieurs bars à Londres."},
      {word:"ne...personne",meaning:"沒有任何人",example:"Je n'aime voyager avec personne."},
      {word:"un animal → des animaux",meaning:"動物（~al→~aux）",example:"J'aime les animaux sauvages."},
      {word:"un journal → des journaux",meaning:"報紙",example:"Je lis les journaux le matin."},
      {word:"un hôpital → des hôpitaux",meaning:"醫院",example:"Il y a plusieurs hôpitaux dans la ville."},
      {word:"national → nationaux",meaning:"國家的",example:"les parcs nationaux"},
      {word:"à manger / à boire",meaning:"吃的/喝的",example:"On doit acheter à manger et à boire."},
      {word:"une bouteille de vin",meaning:"一瓶酒",example:"Quelques bouteilles de vin pour la fête."},
      {word:"une cannette de coca",meaning:"一罐可樂",example:"10 cannettes de coca."},
      {word:"un paquet de chips",meaning:"一包洋芋片",example:"10 paquets de chips."},
      {word:"des jeux de société",meaning:"桌遊",example:"On joue à des jeux de société : les échecs, les cartes."},
      {word:"un feu d'artifice",meaning:"煙火",example:"On regarde le feu d'artifice le 14 juillet."},
      {word:"préférer voyager seul(e)",meaning:"偏好獨自旅行",example:"Je préfère voyager seule. C'est plus libre."},
    ],
    grammar:[
      {title:"數量詞比較",content:"peu de + 可數/不可數 = 很少\nIl a peu de livres.（很少書）\n\nun peu de + 不可數 = 一點點\nJe mets un peu de lait.（一點牛奶）\n⚠️ 不能說 un peu de livres！\n\nquelques + 可數複數 = 幾個\nquelques amis / quelques bouteilles\n\nplusieurs + 可數複數 = 好幾個\nplusieurs bars / plusieurs bus"},
      {title:"~al → ~aux 複數",content:"字尾 -al 的名詞/形容詞，複數變 -aux：\nun animal → des animaux\nun journal → des journaux\nun hôpital → des hôpitaux\nun cheval → des chevaux\nnational → nationaux\n\n⚠️ 例外：un festival → des festivals / un bal → des bals"},
      {title:"ne...personne + 原形動詞",content:"ne...personne 夾住動詞群\nJe n'aime voyager avec personne.（不喜歡跟任何人旅行）\nJe ne veux sortir avec personne.\n\nPC 時：personne 放最後\nJe n'ai vu personne.（我沒看到任何人）\nIl n'a invité personne."},
    ],
    exercises:[
      {type:"選",q:"「我放一點牛奶在咖啡裡」",opts:["Je mets peu de lait.","Je mets un peu de lait.","Je mets quelques lait."],ans:1,exp:"一點（不可數）= un peu de"},
      {type:"填",q:"un animal → des ___ / Je n'ai vu ___ devant la maison.",blanks:["animaux","personne"],hint:"~al→aux / ne...personne = 沒有任何人"},
    ],
    dialogue:[
      {s:"A",t:"On prépare la fête ? Qu'est-ce qu'on achète ?"},
      {s:"B",t:"À manger et à boire : quelques pizzas, plusieurs bouteilles de vin."},
      {s:"A",t:"Et des jeux ?"},
      {s:"B",t:"Oui, des jeux de société et des cartes."},
      {s:"A",t:"Tu invites qui ?"},
      {s:"B",t:"Pour ce voyage, personne ! Je préfère voyager seule."},
    ],
    tip:"peu de = 很少（帶負面）/ un peu de = 一點（正面）\nIl a peu d'amis.（他朋友很少）\nIl a un peu d'argent.（他有一點錢）"
  },
  {
    id:"0721", level:"4", noteLinks:[], date:"07/21", weekday:"一", topic:"avoir+冠詞・COD vs COI・se réveiller・車票",
    tags:["冠詞","COD","COI","反身動詞"],
    summary:[
      {text:"avoir + 定冠詞 = 有某項服務（J'ai la télé = 有電視服務/訊號）"},
      {text:"avoir + un/une/des = 有某個物品（J'ai une télévision = 一台電視機）"},
      {text:"COD（直接受詞）vs COI（間接受詞，前面有 à）"},
      {text:"téléphoner à qqn（COI）vs appeler qqn（COD）"},
      {text:"réciproque 相互：Ils s'aiment.（他們相愛）"},
    ],
    vocabItems:[
      {word:"partager",meaning:"分享/分攤",example:"Je partage un appartement avec un ami."},
      {word:"diviser",meaning:"除以/分",example:"48 euros divisé par 2, c'est 24 euros."},
      {word:"inviter qqn",meaning:"邀請某人",example:"J'ai envie de t'inviter. Tu m'invites ?"},
      {word:"proposer",meaning:"提議",example:"Je propose. On partage."},
      {word:"la prochaine fois",meaning:"下次",example:"Une autre fois, à la prochaine !"},
      {word:"Pas question !",meaning:"門都沒有！",example:"Tu peux me prêter ta voiture ? Pas question !"},
      {word:"Pas de problème",meaning:"沒問題",example:"Pas de problème, mais fais le plein d'essence."},
      {word:"téléphoner à qqn",meaning:"打電話給某人（COI）",example:"Je téléphone à Lucas."},
      {word:"appeler qqn",meaning:"打電話給某人（COD）",example:"J'appelle Lucas."},
      {word:"se réveiller",meaning:"醒來",example:"Fanny réveille Bertrand. Puis il se réveille."},
      {word:"s'aimer (réciproque)",meaning:"相愛",example:"Roméo et Juliette s'aiment."},
      {word:"un ticket de bus / métro",meaning:"公車/捷運票",example:"Un ticket de métro, s'il vous plaît."},
      {word:"un billet de train / d'avion",meaning:"火車/機票",example:"J'ai réservé un billet d'avion."},
      {word:"une entrée",meaning:"門票（博物館/樂園）",example:"Une entrée pour le musée."},
      {word:"retirer / déposer de l'argent",meaning:"提款/存款",example:"Je retire de l'argent au distributeur."},
      {word:"faire le plein d'essence",meaning:"加滿油",example:"Tu dois faire le plein d'essence."},
    ],
    grammar:[
      {title:"avoir + 定冠詞 vs 不定冠詞",content:"avoir + le/la/les = 擁有某項服務/設施\nJ'ai la télé.（有電視訊號/服務）\nJ'ai l'électricité, le téléphone.\n\navoir + un/une/des = 擁有某個具體物品\nJ'ai une télévision.（一台電視機）\nJ'ai un téléphone.（一支電話）"},
      {title:"COD vs COI",content:"COD（直接受詞）：動詞後直接接\nJ'appelle Lucas.（appeler qqn）\nJe le vois.\n\nCOI（間接受詞）：動詞 + à + 人\nJe téléphone à Lucas.（téléphoner à qqn）\nJe lui parle.\n\n⚠️ 常見COI動詞：téléphoner à / parler à / demander à"},
      {title:"réciproque 相互動作",content:"反身代名詞表「互相」：\nIls s'aiment.（他們相愛，互相愛對方）\nRoméo aime Juliette. Juliette aime Roméo. → Ils s'aiment.\nNous nous téléphonons souvent.（我們常互相打電話）\nElles se disputent.（她們互相爭吵）"},
    ],
    exercises:[
      {type:"選",q:"「我打電話給 Lucas」（正確的搭配）",opts:["J'appelle à Lucas.","Je téléphone Lucas.","Je téléphone à Lucas."],ans:2,exp:"téléphoner à qqn（COI）/ appeler qqn（COD）"},
      {type:"填",q:"J'ai ___ télé.（有電視服務）/ Roméo et Juliette s'___.",blanks:["la","aiment"],hint:"avoir+定冠詞=服務 / s'aimer相互"},
    ],
    dialogue:[
      {s:"A",t:"On va au resto demain ? Tu m'invites ?"},
      {s:"B",t:"Je propose, mais on partage !"},
      {s:"A",t:"Pas de problème. À quelle heure ?"},
      {s:"B",t:"Je te téléphone ce soir."},
    ],
    tip:"téléphoner À quelqu'un（COI，要加 à）\nappeler quelqu'un（COD，不加 à）\n兩個都是「打電話」但搭配不同！"
  },
  {
    id:"0723", level:"4", noteLinks:[], date:"07/23", weekday:"四", topic:"coup d'œil・杯子材質・avant/après・soldes",
    tags:["表達","expressions","購物","avant/après"],
    summary:[
      {text:"jeter un coup d'œil = 瞄一眼/看一下"},
      {text:"杯子材質：un gobelet（紙杯）/ un verre（玻璃杯）/ une tasse（瓷杯）"},
      {text:"avant + 名詞 / avant de + 原形；après + 名詞 / après + 複合不定式"},
      {text:"essayer（試穿/試用）vs goûter（試吃）"},
      {text:"les soldes = 折扣季 / un vide-grenier = 二手市集"},
    ],
    vocabItems:[
      {word:"jeter un coup d'œil",meaning:"瞄一眼",example:"Vous avez jeté un coup d'œil sur ces exercices ?"},
      {word:"un gobelet (en papier)",meaning:"紙杯",example:"Jette le gobelet dans la poubelle."},
      {word:"un verre (en verre)",meaning:"玻璃杯",example:"Un verre d'eau, s'il vous plaît."},
      {word:"une tasse (en porcelaine)",meaning:"瓷杯",example:"Une tasse de thé en porcelaine."},
      {word:"donner un coup de main",meaning:"幫忙",example:"Tu peux me donner un coup de main ?"},
      {word:"un coup de pied",meaning:"踢",example:"Il a donné un coup de pied dans le ballon."},
      {word:"Mon œil !",meaning:"才怪！我不信！",example:"Tu dis la vérité ? Mon œil !"},
      {word:"Vous faites quelle taille ?",meaning:"你穿幾號？",example:"Je fais du 38."},
      {word:"Vous mesurez combien ?",meaning:"你多高？",example:"Je mesure 1m60."},
      {word:"essayer un objet",meaning:"試穿/試用",example:"Je peux l'essayer ?"},
      {word:"goûter",meaning:"試吃/品嚐",example:"Vous voulez goûter ce fromage ?"},
      {word:"fréquenter",meaning:"常去/常見",example:"Je fréquente ce café. = J'y vais souvent."},
      {word:"les soldes",meaning:"折扣季",example:"Pendant les soldes, un article acheté = un article offert."},
      {word:"un vide-grenier / une braderie",meaning:"二手市集",example:"J'ai trouvé ce vase dans un vide-grenier."},
      {word:"sélectionner",meaning:"精選",example:"Sélectionner, c'est choisir les meilleurs."},
      {word:"vérifier",meaning:"確認/檢查",example:"Je vérifie le prix avant d'acheter."},
    ],
    grammar:[
      {title:"avant / après 的用法",content:"avant + 名詞：avant le repas（飯前）\navant de + 原形：avant de manger（吃之前）\n\naprès + 名詞：après le cours（課後）\naprès + 複合不定式：après avoir mangé（吃完之後）/ après être arrivé（到達之後）\n\n⚠️ après 接動詞要用「複合不定式」：\naprès avoir lu / après être parti"},
      {title:"essayer vs goûter",content:"essayer = 試（衣服/物品/方法）\nJe peux essayer cette robe ?\nJe peux l'essayer ?（l' = COD）\n\ngoûter = 試吃/品嚐（食物）\nVous voulez goûter ce vin ?\nJe goûte le plat avant de servir."},
    ],
    exercises:[
      {type:"選",q:"「吃之前洗手」",opts:["Lave les mains avant manger.","Lave les mains avant de manger.","Lave les mains avant que manger."],ans:1,exp:"avant de + 原形動詞"},
      {type:"填",q:"Je peux l'___ ?（試穿這件衣服）/ Après ___ mangé, je fais la vaisselle.",blanks:["essayer","avoir"],hint:"試穿=essayer / après avoir + PP"},
    ],
    dialogue:[
      {s:"A",t:"Cette robe est jolie ! Je peux l'essayer ?"},
      {s:"B",t:"Bien sûr ! Vous faites quelle taille ?"},
      {s:"A",t:"Je fais du 38. C'est en solde ?"},
      {s:"B",t:"Oui, pendant les soldes, -50% !"},
    ],
    tip:"jeter un coup d'œil = 看一下/瞄一眼（超口語）\nessayer = 試穿衣服 / goûter = 試吃食物\n別搞混！"
  },
  {
    id:"0728", level:"4", noteLinks:[], date:"07/28", weekday:"一", topic:"租屋・家具・面積・房屋描述",
    tags:["住宅","logement","meubles","旅遊"],
    summary:[
      {text:"louer un logement vide（空屋）ou meublé（附家具）"},
      {text:"家具：table / chaise / étagère / armoire / placard / lit"},
      {text:"面積：Il fait combien de m² ? = Quelle est la surface ?"},
      {text:"房屋描述：bien situé / ensoleillé / avec vue sur..."},
      {text:"À saisir !（超值/要搶要快！）"},
    ],
    vocabItems:[
      {word:"louer",meaning:"租",example:"Je loue un appartement à Taipei."},
      {word:"un logement vide / meublé",meaning:"空屋/附家具的房子",example:"Vous préférez un logement vide ou meublé ?"},
      {word:"un meuble",meaning:"家具",example:"Une table, une chaise, une armoire sont des meubles."},
      {word:"une étagère",meaning:"層架",example:"Je range mes livres sur l'étagère."},
      {word:"une armoire",meaning:"衣櫃",example:"Je mets mes vêtements dans l'armoire."},
      {word:"un placard",meaning:"櫥櫃",example:"La vaisselle est dans le placard."},
      {word:"la surface",meaning:"面積",example:"Quelle est la surface de l'appartement ?"},
      {word:"faire ... m²",meaning:"有...平方公尺",example:"L'appartement fait 80 mètres carrés."},
      {word:"bien situé(e)",meaning:"位置好",example:"La maison est bien située, derrière la gare."},
      {word:"ensoleillé(e)",meaning:"陽光充足",example:"Une chambre ensoleillée avec vue sur le parc."},
      {word:"avec vue sur",meaning:"有...的景觀",example:"Un appartement avec vue sur la mer."},
      {word:"À saisir !",meaning:"要搶要快！超值！",example:"Cette maison coûte 250 000 euros. À saisir !"},
      {word:"un studio",meaning:"套房",example:"Un joli studio au 2e étage."},
      {word:"un immeuble",meaning:"公寓大樓",example:"Il habite dans un bel immeuble moderne."},
      {word:"faire du jardinage",meaning:"做園藝",example:"J'aime faire du jardinage le week-end."},
      {word:"une allocation logement",meaning:"房屋補助",example:"Je reçois une allocation pour le logement."},
    ],
    grammar:[
      {title:"描述房屋的句型",content:"位置：Elle est bien située, derrière la gare, en face du parc.\n樓層：Il est au 3e étage d'un bel immeuble.\n面積：Il fait 80 m². / Elle fait 140 mètres carrés.\n特色：belle, ensoleillée, avec vue sur le parc\n價格：Elle coûte 250 000 euros.\n\n完整例句：\nC'est une maison à vendre. Elle est bien située, avec un petit jardin. Elle fait 140 m². À saisir !"},
    ],
    exercises:[
      {type:"選",q:"「這間公寓面積多大？」",opts:["Combien l'appartement fait ?","Quelle est la surface de l'appartement ?","Combien de surface l'appartement ?"],ans:1,exp:"Quelle est la surface... / Il fait combien de m²"},
      {type:"填",q:"Je préfère un logement ___ parce que je n'ai pas de meubles.（附家具）/ La maison est ___ sur le parc.",blanks:["meublé","avec vue"],hint:"附家具=meublé / avec vue sur"},
    ],
    dialogue:[
      {s:"A",t:"Vous cherchez un logement vide ou meublé ?"},
      {s:"B",t:"Meublé, je n'ai pas de meubles."},
      {s:"A",t:"J'ai un studio ensoleillé au 2e étage. Il fait 30 m²."},
      {s:"B",t:"Il est bien situé ?"},
      {s:"A",t:"Oui, en face du parc, avec vue ! À saisir !"},
      {s:"B",t:"Je le prends !"},
    ],
    tip:"un logement vide = 空屋（沒家具）\nun logement meublé = 附家具\nÀ saisir ! = 房仲廣告常見「超值要搶要快」"
  },
  {
    id:"0730", level:"4", noteLinks:[], date:"07/30", weekday:"四", topic:"avoir la pêche・être+pp・avoir mal vs du mal・Pour...il faut",
    tags:["表達","être","avoir mal","il faut"],
    summary:[
      {text:"avoir la pêche = avoir la forme = être en forme（精神好）"},
      {text:"être + PP 兩種：① 移動動詞過去式 ② 被動語態（pp當形容詞）"},
      {text:"avoir mal = 痛 / avoir du mal (à) = 有困難"},
      {text:"Pour + 目的, il faut + 需要的東西"},
      {text:"avoir raison ≠ avoir tort（對 vs 錯）"},
    ],
    vocabItems:[
      {word:"avoir la pêche",meaning:"精神好/有活力",example:"Aujourd'hui j'ai la pêche !"},
      {word:"klaxonner",meaning:"按喇叭",example:"Ne klaxonne pas, c'est interdit la nuit !"},
      {word:"féliciter",meaning:"恭喜",example:"Je te félicite pour ton examen !"},
      {word:"avoir raison ≠ avoir tort",meaning:"有理≠錯",example:"Tu as raison. / Il a tort."},
      {word:"large ≠ étroit",meaning:"寬≠窄",example:"Le chemin est large. La rue est étroite."},
      {word:"avoir mal",meaning:"痛",example:"J'ai mal à la tête."},
      {word:"avoir du mal à",meaning:"有困難",example:"J'ai du mal à finir mes devoirs."},
      {word:"décider / prendre la décision",meaning:"決定",example:"J'ai décidé de partir. J'ai pris la décision."},
      {word:"les Sinophones",meaning:"說中文的人",example:"Il parle chinois, il est sinophone."},
      {word:"Pour... il faut...",meaning:"為了...需要...",example:"Pour voyager, il faut un passeport."},
      {word:"de bonnes chaussures",meaning:"好鞋子",example:"Pour la randonnée, il faut de bonnes chaussures."},
      {word:"réussir les examens",meaning:"考試成功",example:"Pour réussir, il faut bien réviser."},
      {word:"être tombé(e)",meaning:"跌倒了（移動）",example:"Je suis tombée dans la rue."},
      {word:"être intéressé(e)",meaning:"感興趣（被動）",example:"Je suis intéressée par ce projet."},
    ],
    grammar:[
      {title:"être + PP：移動 vs 被動",content:"① 移動動詞的複合過去式（PP配合主詞）\nElle est entrée. / Il est parti. / Il est monté.\n\n② 被動語態（PP當形容詞，描述狀態）\nLa porte est fermée.（門是關著的）\nElle est intéressée.（她感興趣）\nIl est frappé.（他被打）\n\n分辨：移動=動作發生 / 被動=狀態描述"},
      {title:"avoir mal vs avoir du mal",content:"avoir mal (à) = 身體某處痛\nJ'ai mal à la tête.（頭痛）\nJ'ai mal au ventre.（肚子痛）\n\navoir du mal (à) = 做某事有困難\nJ'ai du mal à finir mes devoirs.（我很難完成作業）\nJ'ai du mal à prononcer ce mot.（這個字我很難唸）"},
      {title:"Pour + 目的, il faut + 需要",content:"Pour + 名詞/原形, il faut + 名詞/原形\nPour boire de l'eau, il faut un verre.\nPour voyager à l'étranger, il faut un passeport.\nPour réussir, il faut bien réviser.\n\n= vous devez + 原形\nPour voyager, vous devez prendre votre passeport."},
    ],
    exercises:[
      {type:"選",q:"「我很難完成作業」",opts:["J'ai mal à finir mes devoirs.","J'ai du mal à finir mes devoirs.","Je suis mal à finir mes devoirs."],ans:1,exp:"avoir du mal à = 有困難 / avoir mal à = 身體痛"},
      {type:"填",q:"J'ai ___ à la tête.（頭痛）/ Pour la randonnée, il ___ de bonnes chaussures.",blanks:["mal","faut"],hint:"avoir mal à = 痛 / il faut = 需要"},
    ],
    dialogue:[
      {s:"A",t:"Ça va ? Tu as l'air fatiguée."},
      {s:"B",t:"Non, aujourd'hui j'ai la pêche !"},
      {s:"A",t:"Super ! Tu as réussi ton examen ?"},
      {s:"B",t:"Oui ! Mais j'ai eu du mal à réviser."},
      {s:"A",t:"Je te félicite ! Tu as raison d'être contente."},
      {s:"B",t:"Merci !"},
    ],
    tip:"avoir mal à = 身體痛（J'ai mal au dos）\navoir du mal à = 做事有困難（J'ai du mal à comprendre）\n差一個 du，意思完全不同！"
  },
  {
    id:"0804", level:"4", noteLinks:[], date:"08/04", weekday:"一", topic:"行政流程・感嘆句・y/en 代名詞・avoir hâte",
    tags:["行政","感嘆句","代名詞","y/en"],
    summary:[
      {text:"行政場所：la mairie（市政廳）/ l'accueil（櫃台）/ un formulaire（表格）"},
      {text:"感嘆句：Quel(le) + 名詞 !（Quelle belle journée !）"},
      {text:"y = 代替「介係詞（非de）+ 地方」/ en = 代替「de + 名詞」"},
      {text:"avoir hâte de + 原形 = 迫不及待"},
      {text:"Ça fait longtemps qu'on ne s'est pas vus !（好久不見）"},
    ],
    vocabItems:[
      {word:"la mairie",meaning:"市政廳",example:"Je suis allé à la mairie ce matin."},
      {word:"l'accueil",meaning:"接待櫃台",example:"J'ai demandé le formulaire à l'accueil."},
      {word:"un formulaire",meaning:"表格",example:"Je remplis le formulaire 2042."},
      {word:"faire la queue",meaning:"排隊",example:"J'ai attendu longtemps parce qu'il y avait la queue."},
      {word:"Quelle belle journée !",meaning:"多美好的一天！",example:"Quelle belle journée ! Il fait beau."},
      {word:"Quel gaspillage !",meaning:"真浪費！",example:"Quel gaspillage de jeter cette nourriture !"},
      {word:"avoir hâte de",meaning:"迫不及待",example:"J'ai hâte de partir en vacances !"},
      {word:"Ça fait longtemps qu'on ne s'est pas vus",meaning:"好久不見",example:"Salut ! Ça fait longtemps qu'on ne s'est pas vus !"},
      {word:"un voyage d'affaires",meaning:"出差",example:"Il fait un voyage d'affaires à Paris."},
      {word:"y（代名詞）",meaning:"代替 à+地方",example:"Tu vas à Paris ? Oui, j'y vais."},
      {word:"en（代名詞）",meaning:"代替 de+名詞",example:"Tu as des livres ? Oui, j'en ai."},
      {word:"un arrêt de bus / un abribus",meaning:"公車站",example:"J'attends à l'arrêt de bus."},
      {word:"les sans-abris",meaning:"無家可歸的人",example:"Les sans-abris dorment dans la rue."},
      {word:"tout de suite",meaning:"立刻",example:"Je voudrais faire ça tout de suite !"},
    ],
    grammar:[
      {title:"感嘆句 Quel(le) + 名詞",content:"Quel + 陽性名詞 !：Quel beau voyage !\nQuelle + 陰性名詞 !：Quelle belle journée !\nQuels / Quelles + 複數\n\nQuelle pluie !（好大的雨！）\nQuel gaspillage !（真浪費！）\nQuelle bonne idée !（好主意！）"},
      {title:"代名詞 y 和 en",content:"y = 代替「à/dans/sur/chez + 地方」\nTu vas à Paris ? → Oui, j'y vais.\nIl n'y a pas de bus. → Il n'y en a pas.\n\nen = 代替「de + 名詞」\nTu as des livres ? → Oui, j'en ai.\nTu bois du café ? → Oui, j'en bois.\n\n⚠️ toutes les prépositions sauf de → y\nde + nom → en"},
      {title:"avoir hâte de + 原形",content:"avoir hâte de = 迫不及待想...\nJ'ai hâte de partir en vacances !\nJ'ai hâte d'aller au concert !\nJ'ai hâte de te voir !"},
    ],
    exercises:[
      {type:"選",q:"「多美好的一天！」",opts:["Quel belle journée !","Quelle belle journée !","Que belle journée !"],ans:1,exp:"journée 陰性 → Quelle"},
      {type:"填",q:"Tu vas à Paris ? Oui, j'___ vais. / Tu as du café ? Oui, j'___ ai.",blanks:["y","en"],hint:"à+地方→y / de+名詞→en"},
    ],
    dialogue:[
      {s:"A",t:"Salut ! Ça fait longtemps qu'on ne s'est pas vus !"},
      {s:"B",t:"Oui ! Quelle bonne surprise !"},
      {s:"A",t:"Tu pars en vacances bientôt ?"},
      {s:"B",t:"Oui, j'ai hâte de partir ! J'y vais la semaine prochaine."},
    ],
    tip:"y = 代替地方（j'y vais = 我去那裡）\nen = 代替 de+名詞（j'en ai = 我有一些）\n兩個超重要的代名詞！"
  },
  {
    id:"0806", level:"4", noteLinks:[], date:"08/06", weekday:"四", topic:"私人領域・interdit・y 代名詞・果樹・COD vs COI",
    tags:["表達","interdit","代名詞","COD","COI"],
    summary:[
      {text:"propriété privée = 私人領域 / interdit = 禁止"},
      {text:"C'est réservé au personnel.（僅限員工）"},
      {text:"y = 代替「à + 地方」（J'y vais = 我去那裡）"},
      {text:"果樹字尾 -ier：pomme→pommier / cerise→cerisier"},
      {text:"COD vs COI + 代名詞：le/la（COD）vs lui（COI）"},
    ],
    vocabItems:[
      {word:"une propriété privée",meaning:"私人領域",example:"C'est écrit « propriété privée » sur le panneau."},
      {word:"interdit(e)",meaning:"禁止的",example:"On ne peut pas entrer, c'est interdit."},
      {word:"un panneau",meaning:"告示牌",example:"Regarde le panneau : « Sortie »."},
      {word:"C'est réservé au personnel",meaning:"僅限員工",example:"Cette porte est réservée au personnel."},
      {word:"un fermier",meaning:"農夫",example:"On va demander au fermier."},
      {word:"les passants",meaning:"路人",example:"On va demander aux passants."},
      {word:"Ça marche !",meaning:"沒問題！好啊！",example:"On y va ? Ça marche !"},
      {word:"un pommier",meaning:"蘋果樹",example:"une pomme → un pommier"},
      {word:"un cerisier",meaning:"櫻桃樹",example:"On voit des cerisiers en fleurs au Japon."},
      {word:"un bananier",meaning:"香蕉樹",example:"une banane → un bananier"},
      {word:"un rosier",meaning:"玫瑰花叢",example:"une rose → un rosier"},
      {word:"un abricotier",meaning:"杏桃樹",example:"un abricot → un abricotier"},
      {word:"demander à qqn",meaning:"問某人（COI）",example:"Jérôme demande à Bertrand."},
      {word:"lui (COI)",meaning:"給他/她",example:"Je lui demande de m'aider."},
      {word:"faire tomber",meaning:"弄倒/打翻",example:"J'ai fait tomber mon thé."},
    ],
    grammar:[
      {title:"y 代替地方",content:"y = à/dans/sur + 地方\nOn va à la forêt ? On y va !\nTu vas à la fête ? Oui, j'y vais.\nJe pense à mon voyage. → J'y pense.\n\n⚠️ y 放在動詞前\nJ'y vais. / On y va ! / Je n'y vais pas."},
      {title:"果樹的字尾 -ier",content:"水果 → 果樹（加 -ier）\nune pomme → un pommier（蘋果樹）\nune cerise → un cerisier（櫻桃樹）\nune banane → un bananier\nun abricot → un abricotier\nune rose → un rosier（玫瑰叢）\n\n⚠️ 果樹都是陽性！"},
      {title:"COD vs COI + 代名詞",content:"COD（直接受詞）→ le/la/les\nJ'aide Bertrand. → Je l'aide.\n\nCOI（間接受詞，à+人）→ lui/leur\nJe demande à Bertrand. → Je lui demande.\nJe parle à mes amis. → Je leur parle.\n\n⚠️ demander à qqn de faire = 請某人做某事\nJe lui demande de m'aider."},
    ],
    exercises:[
      {type:"選",q:"「我們去那裡吧！」（forêt）",opts:["On va !","On y va !","On le va !"],ans:1,exp:"y 代替地方（à la forêt）"},
      {type:"填",q:"une pomme → un ___ / Je ___ demande de m'aider.（à Bertrand）",blanks:["pommier","lui"],hint:"水果+ier=果樹 / COI人→lui"},
    ],
    dialogue:[
      {s:"A",t:"Regarde cette forêt ! On y fait un pique-nique ?"},
      {s:"B",t:"On ne peut pas, c'est une propriété privée."},
      {s:"A",t:"On demande au fermier ?"},
      {s:"B",t:"Bonne idée. On y va ? Ça marche !"},
    ],
    tip:"y = 代替地方（j'y vais）\n果樹 = 水果 + ier（pommier, cerisier）都是陽性\nlui = 給他/她（COI）"
  },
  {
    id:"0811", level:"4", noteLinks:[], date:"08/11", weekday:"一", topic:"搬家・habiter à・工作詞彙・ville vs campagne",
    tags:["住宅","déménager","工作","比較"],
    summary:[
      {text:"搬家系列：déménager / s'installer / quitter son ancien logement"},
      {text:"habiter (à) + 城市：J'habite (à) Paris"},
      {text:"⚠️ 帶冠詞的城市：Le Havre → J'habite au Havre"},
      {text:"工作的說法：un poste / un travail / un boulot / un job / un emploi"},
      {text:"ville vs campagne 城鄉比較（口說練習主題）"},
    ],
    vocabItems:[
      {word:"déménager",meaning:"搬家",example:"Elle a déménagé. Elle a quitté son ancien logement."},
      {word:"s'installer",meaning:"定居/安頓",example:"Elle s'est installée dans une nouvelle ville."},
      {word:"quitter",meaning:"離開",example:"Elle a quitté Marseille."},
      {word:"son ancien logement",meaning:"舊住處",example:"Elle a quitté son ancien logement."},
      {word:"Excuse mon silence",meaning:"抱歉這麼久沒聯絡",example:"Excuse mon silence, j'étais très occupée."},
      {word:"un poste / un boulot / un emploi",meaning:"工作",example:"Elle a trouvé un nouveau poste."},
      {word:"fabriquer",meaning:"製造",example:"L'usine fabrique des avions."},
      {word:"une demi-heure",meaning:"半小時",example:"Ça prend une demi-heure en bus."},
      {word:"un demi-kilo",meaning:"半公斤",example:"Un demi-kilo de tomates, s'il vous plaît."},
      {word:"pratique / un avantage",meaning:"方便/優點",example:"En ville, le transport est pratique."},
      {word:"un inconvénient",meaning:"缺點",example:"L'inconvénient de la ville, c'est le bruit."},
      {word:"être isolé(e)",meaning:"孤立/與世隔絕",example:"À la campagne, on peut se sentir isolé."},
      {word:"en ville ≠ à la campagne",meaning:"在城市≠在鄉下",example:"Vous préférez habiter en ville ou à la campagne ?"},
      {word:"se déplacer",meaning:"移動/出行",example:"À la campagne, se déplacer sans voiture est difficile."},
      {word:"faire du jardinage",meaning:"做園藝",example:"À la campagne, on peut faire du jardinage."},
    ],
    grammar:[
      {title:"habiter (à) + 城市",content:"habiter 可加 à 或不加，都對：\nJ'habite Paris. = J'habite à Paris.\n\n⚠️ 帶冠詞的城市名要縮寫：\nLe Havre → J'habite au Havre.\nLe Mans → J'habite au Mans.\nLe Caire → J'habite au Caire.\n\n（le + 母音/à = au）"},
      {title:"prendre vs mettre（花時間）",content:"Ça prend combien de temps ? = Tu mets combien de temps ?\nJe viens en bus et ça prend 20 minutes.\n= Je mets 20 minutes.\n\ndemi 的用法：\nune demi-heure（半小時）\nun demi-kilo（半公斤）\nune demi-bouteille（半瓶）"},
    ],
    exercises:[
      {type:"選",q:"「我住在 Le Havre」",opts:["J'habite à Le Havre.","J'habite au Havre.","J'habite le Havre à."],ans:1,exp:"le + 城市 → au（Le Havre → au Havre）"},
      {type:"填",q:"Elle a ___ son ancien logement.（離開）/ Ça prend une ___-heure.",blanks:["quitté","demi"],hint:"離開=quitter / 半小時=demi-heure"},
    ],
    dialogue:[
      {s:"A",t:"Tu préfères habiter en ville ou à la campagne ?"},
      {s:"B",t:"En ville ! Le transport est pratique et j'aime le shopping."},
      {s:"A",t:"Moi, je préfère la campagne. On a une grande maison avec jardin."},
      {s:"B",t:"Mais c'est isolé, non ?"},
      {s:"A",t:"Un peu, mais j'aime conduire, donc ça va !"},
    ],
    tip:"habiter à Paris / habiter Paris（都對）\n⚠️ 帶冠詞城市：au Havre, au Mans, au Caire\ndéménager = 搬家 / s'installer = 安頓下來"
  }
];
...
const GRAMMAR=[
  ...
  {id:"g023",date:"07/14",type:"grammar",title:"gérondif：en + 現在分詞",tags:["gérondif","動詞"],rules:["gérondif = en + 現在分詞 = 一邊...一邊","現在分詞：動詞 nous 形去 -ons + -ant","regarder → regardant / finir → finissant","Je dine EN regardant la télé.（一邊看電視一邊吃飯）","⚠️ 例外：être→étant / avoir→ayant / savoir→sachant"],myExamples:["Je fais mes devoirs en chantant.","Elle prend son café en écoutant de la musique.","Il est tombé en courant."],mySentences:[]},
...
const VOCAB=[
  {id:"v035",date:"08/23",type:"vocab",title:"Bien-dire：la rentrée 閱讀",tags:["文化","表達","學習"],items:[
    ...
    {fr:"un poste / un boulot / un emploi",zh:"工作",ex:"Elle a trouvé un nouveau poste à Lyon."},
    {fr:"élever des animaux",zh:"養動物/畜牧",ex:"Le fermier élève des poules et des vaches."},
    {fr:"cultiver",zh:"種植/耕種",ex:"Il cultive des légumes dans son jardin."},
    {fr:"une ferme / un fermier",zh:"農場/農夫",ex:"Maxime a une ferme à la campagne."},
    {fr:"animé(e)",zh:"熱鬧的",ex:"La vie en ville est animée et rapide."},
    {fr:"être isolé(e)",zh:"孤立/與世隔絕",ex:"À la campagne, je me sens un peu isolée."},
    {fr:"l'air frais",zh:"新鮮空氣",ex:"À la campagne, l'air est frais."},
    {fr:"la circulation",zh:"交通/車流",ex:"En ville, il y a trop de circulation."},
    {fr:"les espaces verts",zh:"綠地",ex:"Il n'y a pas assez d'espaces verts en ville."},
  ]},
  {id:"v033",date:"08/06",type:"vocab",title:"行政・自然・果樹",tags:["日常","實用","表達"],items:[
    {fr:"la mairie",zh:"市政廳",ex:"Je suis allé à la mairie pour un formulaire."},
    {fr:"l'accueil",zh:"接待櫃台",ex:"Demandez à l'accueil, s'il vous plaît."},
    {fr:"un formulaire",zh:"表格",ex:"Je dois remplir ce formulaire."},
    {fr:"faire la queue",zh:"排隊",ex:"J'ai fait la queue pendant une heure."},
    {fr:"avoir hâte de",zh:"迫不及待",ex:"J'ai hâte de partir en vacances !"},
    {fr:"une propriété privée",zh:"私人領域",ex:"On ne peut pas entrer, c'est une propriété privée."},
    {fr:"interdit(e)",zh:"禁止的",ex:"C'est interdit d'entrer ici."},
    {fr:"un fermier",zh:"農夫",ex:"On va demander au fermier."},
    {fr:"les passants",zh:"路人",ex:"On va demander aux passants."},
    {fr:"un pommier",zh:"蘋果樹",ex:"une pomme → un pommier"},
    {fr:"un cerisier",zh:"櫻桃樹",ex:"On voit des cerisiers en fleurs au Japon."},
    {fr:"un abricotier",zh:"杏桃樹",ex:"un abricot → un abricotier"},
    {fr:"voler",zh:"飛/偷",ex:"Les oiseaux volent. / Le voleur a volé mon sac."},
  ]},
  {id:"v032",date:"07/30",type:"vocab",title:"租屋・房屋狀況",tags:["日常","住宅","實用"],items:[
    {fr:"louer / le loyer",zh:"租/房租",ex:"Je loue un appartement. Le loyer est de 800 euros."},
    {fr:"un(e) locataire",zh:"房客",ex:"Pierre est locataire de cette maison."},
    {fr:"un(e) propriétaire",zh:"房東",ex:"Paul est le propriétaire de la maison."},
    {fr:"un(e) colocataire",zh:"室友",ex:"Je partage le loyer avec un colocataire."},
    {fr:"un meuble",zh:"家具",ex:"Une table, une chaise sont des meubles."},
    {fr:"une étagère",zh:"層架",ex:"Je range mes livres sur l'étagère."},
    {fr:"une armoire",zh:"衣櫃",ex:"Mes vêtements sont dans l'armoire."},
    {fr:"un placard",zh:"櫥櫃",ex:"La vaisselle est dans le placard."},
    {fr:"être en panne",zh:"故障",ex:"Ma voiture est en panne."},
    {fr:"réparer",zh:"修理",ex:"Le garagiste va réparer ma voiture."},
    {fr:"repeindre les murs",zh:"重新粉刷牆壁",ex:"Il faut repeindre les murs."},
    {fr:"une fuite",zh:"漏水",ex:"Il y a une fuite dans la salle de bains."},
    {fr:"le chauffage",zh:"暖氣",ex:"L'appartement est chauffé à l'électricité."},
  ]},
  {id:"v031",date:"07/23",type:"vocab",title:"表達・購物",tags:["表達","購物","日常"],items:[
    {fr:"jeter un coup d'œil",zh:"瞄一眼",ex:"Vous avez jeté un coup d'œil sur ces exercices ?"},
    {fr:"donner un coup de main",zh:"幫忙",ex:"Tu peux me donner un coup de main ?"},
    {fr:"Mon œil !",zh:"才怪！我不信！",ex:"Tu dis la vérité ? Mon œil !"},
    {fr:"fréquenter",zh:"常去/常見",ex:"Je fréquente ce café. = J'y vais souvent."},
    {fr:"les soldes",zh:"折扣季",ex:"Pendant les soldes, tout est moins cher."},
    {fr:"un vide-grenier / une braderie",zh:"二手市集",ex:"J'ai trouvé ce vase dans un vide-grenier."},
    {fr:"un fauteuil roulant",zh:"輪椅",ex:"Il se déplace en fauteuil roulant."},
    {fr:"prêter ≠ emprunter",zh:"借出≠借入",ex:"Paul prête un livre. J'emprunte un livre à Paul."},
    {fr:"sélectionner",zh:"精選/挑選",ex:"Sélectionner, c'est choisir les meilleurs."},
    {fr:"vérifier",zh:"確認/檢查",ex:"Je vérifie le prix avant d'acheter."},
  ]},
  {id:"v030",date:"07/16",type:"vocab",title:"作品・藝術・數量",tags:["文化","表達","學習"],items:[
    {fr:"une œuvre",zh:"作品",ex:"C'est l'œuvre d'un grand peintre."},
    {fr:"un écrivain",zh:"作家",ex:"Camus est un écrivain français célèbre."},
    {fr:"un peintre",zh:"畫家",ex:"Le peintre a fait ce tableau."},
    {fr:"un sculpteur",zh:"雕塑家",ex:"Le sculpteur a créé cette statue."},
    {fr:"un compositeur",zh:"作曲家",ex:"Mozart est un grand compositeur."},
    {fr:"une statue",zh:"雕像",ex:"Il y a une statue dans le parc."},
    {fr:"il y a du monde",zh:"很多人",ex:"Il y a beaucoup de monde dans ce restaurant."},
    {fr:"une auberge de jeunesse",zh:"青年旅舍",ex:"C'est moins cher qu'un hôtel."},
    {fr:"un mensonge",zh:"謊言",ex:"Ne dis pas de mensonges !"},
  ]},
  {id:"v029",date:"07/14",type:"vocab",title:"命令式・反身・日常表達",tags:["表達","反身動詞","日常"],items:[
    {fr:"faire une sieste",zh:"午睡",ex:"Le dimanche, je fais une sieste."},
    {fr:"être fâché(e) / en colère",zh:"生氣",ex:"Elle est fâchée. Elle est en colère."},
    {fr:"mentir",zh:"說謊",ex:"Il ment, il ne dit pas la vérité."},
    {fr:"un menteur / une menteuse",zh:"騙子",ex:"Menteur ! Je ne crois pas !"},
    {fr:"s'inquiéter",zh:"擔心",ex:"Ne vous inquiétez pas, tout va bien."},
    {fr:"s'énerver",zh:"動怒/煩躁",ex:"Ne t'énerve pas ! Discutons calmement."},
    {fr:"s'amuser",zh:"玩得開心",ex:"Amusez-vous bien, les enfants !"},
    {fr:"des plats préparés",zh:"現成菜",ex:"J'achète des plats préparés au supermarché."},
    {fr:"le traiteur",zh:"外燴/熟食店",ex:"On commande chez le traiteur pour la fête."},
    {fr:"le soleil / la lune / les étoiles",zh:"太陽/月亮/星星",ex:"J'aime regarder les étoiles la nuit."},
    {fr:"Ça te va bien !",zh:"很適合你！",ex:"Tu as changé de coiffure ? Ça te va bien !"},
    {fr:"Bon rétablissement !",zh:"早日康復！",ex:"Tu es malade ? Bon rétablissement !"},
  ]},
...
export default function App(){
  ...
  const filteredGrouped=filteredChapters.reduce((acc,ch)=>{
    ...
    const key=m==='01'?'一月':m==='02'?'二月':m==='03'?'三月':m==='04'?'四月':m==='05'?'五月（三級）':m==='06'?'六月（三級）':m==='07'?'七月（四級）':m==='08'?'八月（四級）':'其他';
